...
export function ModalProvider({ children }: { children: ReactNode }) {
  ...
  const [onModalClose, setOnModalClose] = useState<CallableFunction | null>(null);
...
export function Modal() {
  const { modalRef, modalContent, closeModal } = useContext(ModalContext) as ModalContextType;
